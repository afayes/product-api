...
class ProductControllerIT {
    ...
    @Test
    @DisplayName("Get products when label type is ShowPercDscount should return products with percent discount")
    void getProductsWhenLabelTypeIsShowPercDscountShouldReturnProductsWithPercentDiscount() throws Exception {
