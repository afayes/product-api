...
class ProductServiceTest {
    ...
    @Test
    @DisplayName("Get products when label type is ShowPercDscount should return price label with percent off and now price")
    void getProductsWhenLabelTypeIsShowPercDscountShouldReturnPriceLabelWithPercentOffAndNowPrice() {
        final ExternalProduct externalProduct = ExternalProduct.builder()
                .productId("id")
                .price(ExternalPrice.builder()
